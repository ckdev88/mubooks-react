...
const NavWrapper = () => {
	...
	return (
		<>
			<div className={nav0Expanded || nav1Expanded ? 'anyexpanded' : 'allcollapsed'}>
				<nav id="navIcons">
					<button
						id="toggleNavBurger"
					...
					<div style={{ display: 'flex', alignContent: 'center' }}>
						...
						<button
							...
							onClick={toggleNav1}
						>
							<span className="alt">Profile</span>
							<svg
								width="800px"
								height="800px"
								viewBox="0 0 20 20"
				...
				>
					<ul>
						<li>
							<NavLink to={'/account/profile'} onClick={toggleNav1}>
								Profile
							</NavLink>
						</li>
						<li>
							<NavLink to={'/account/logout'} onClick={toggleNav1}>
								Logout
							</NavLink>
						</li>
					</ul>
